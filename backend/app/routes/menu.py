...
class MenuSectionCreate(BaseModel):
    ...
    layout: str = Field(default="grid", pattern="^(grid|list|horizontal)$")
...
class MenuSectionUpdate(BaseModel):
    ...
    description: Optional[str] = Field(None, max_length=500)
    icon: Optional[str] = Field(None, max_length=10)
    layout: Optional[str] = Field(None, pattern="^(grid|list|horizontal)$")
...
class MenuItemCreate(BaseModel):
    ...
    description: Optional[str] = Field(None, max_length=500)
    icon: Optional[str] = Field(None, max_length=10)
    action_type: str = Field(..., pattern="^(screen|url|action|section)$")
...
class MenuItemUpdate(BaseModel):
    ...
    description: Optional[str] = Field(None, max_length=500)
    icon: Optional[str] = Field(None, max_length=10)
    action_type: Optional[str] = Field(None, pattern="^(screen|url|action|section)$")
    action_value: Optional[str] = Field(None)
    parent_id: Optional[str] = Field(None)
    section_id: Optional[str] = Field(None)
    sort_order: Optional[int] = Field(None)
