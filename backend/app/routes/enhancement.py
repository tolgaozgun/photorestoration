    ...
    try:
        ...
        try:
            ...
            return EnhancementResponse(
                ...
                enhanced_url=storage_service.get_full_url(image_keys['enhanced_url'], use_presigned=False),
                thumbnail_url=storage_service.get_full_url(image_keys.get('thumbnail_url'), use_presigned=False) if image_keys.get('thumbnail_url') else None,
                preview_url=storage_service.get_full_url(image_keys.get('preview_url'), use_presigned=False) if image_keys.get('preview_url') else None,
                blurhash=blurhash,
                watermark=watermark,
                processing_time=processing_time,
        ...
        return [
            {
                ...
                "original_url": storage_service.get_full_url(enhancement.original_url, use_presigned=False),
                "enhanced_url": storage_service.get_full_url(enhancement.enhanced_url, use_presigned=False),
                "thumbnail_url": storage_service.get_full_url(enhancement.thumbnail_url, use_presigned=False) if enhancement.thumbnail_url else None,
                "preview_url": storage_service.get_full_url(enhancement.preview_url, use_presigned=False) if enhancement.preview_url else None,
